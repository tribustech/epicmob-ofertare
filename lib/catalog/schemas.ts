...
export const settingsSchema = z.object({
  ...
  roundedCutPricePerPiece: z.preprocess(emptyToUndefined, num.nonnegative().default(0)),
  roundedEdgePricePerPiece: z.preprocess(emptyToUndefined, num.nonnegative().default(0)),
  blatEdgeBandId: optId,
