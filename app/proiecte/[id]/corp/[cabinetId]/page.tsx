...
function cabinetInputToFormValues(input: CabinetInput): Record<string, string> {
  ...
  return {
    ...
    hingeCount: input.hardwareSel?.hingeCount != null ? String(input.hardwareSel.hingeCount) : '',
    ...
    handleCount: input.hardwareSel?.handleCount != null ? String(input.hardwareSel.handleCount) : '',
